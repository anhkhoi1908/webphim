...
<body>
    <div id="app">
        @if(Auth::id())
            <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm" style="background: #5dc2a7 !important">
            <div class="container">
    ...
    <script type="text/javascript">
        let tableCategory = new DataTable('#tablecategory');
        let tableGenre = new DataTable('#tablegenre');
        let tableCountry = new DataTable('#tablecountry');
        let tableMovie = new DataTable('#tablemovie');
        let tableEpisode = new DataTable('#tableepisode');
    </script>
    ...
    <script type="text/javascript">
        $('.select-topview').change(function() {
            ...
            $.ajax({
                ...
                success: function() {
                    alert('Thay đổi phim theo top '+text+' thành công!');
                }
            });
        })
    </script>
