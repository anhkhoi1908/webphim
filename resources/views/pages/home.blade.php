    ...
    <div id="halim_related_movies-2xx" class="wrap-slider">
      ...
      <div class="section-heading">
         <a href="danhmuc.php" title="Phim Bộ">
            <span class="h-text" style="border-radius: 4px;">Phim Sắp Công Chiếu</span>
         </a>
      </div>
      <div id="halim_related_movies-3" class="owl-carousel owl-theme">
      ...
      <div class="section-heading">
         <a href="danhmuc.php" title="Phim Bộ">
            <span class="h-text" style="border-radius: 4px;">Phim Mới Nổi Bật</span>
         </a>
      </div>
      <div id="halim_related_movies-2" class="owl-carousel owl-theme">
   ...
   <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
     @foreach($category_home as $key => $cate_home)
      <section id="halim-advanced-widget-2">
         <div class="section-heading">
            <a href="danhmuc.php" title="Phim Bộ">
               <span class="h-text" style="border-radius: 4px">{{$cate_home->title}}</span>
            </a>
         </div>
