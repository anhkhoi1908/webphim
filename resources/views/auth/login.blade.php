    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="row mt-4">
            <div class="col-md-8 offset-md-4 px-0">
                <button type="submit" class="btn text-white" style="background: linear-gradient(#662D8C,#ED1E79);">
                    <i class="fas fa-sign-in-alt mr-2"></i> {{ __('Login') }}
                </button>
            </div>
        </div>

        <div class="row mt-2 mb-5 text-end">
            <div class="col-md-8 offset-md-4 px-0">
        ...
        <div class="row mb-0">
            <p class="text-white px-0">Have no account yet?</p>
            <div class="col-md-8 px-0">
                <button type="submit" class="btn text-white" style="background: linear-gradient(#662D8C,#ED1E79);">
                    <i class="fas fa-user-plus"></i> {{ __('Create A New Account') }}
                </button>
            </div>
        </div>
   </div> 
